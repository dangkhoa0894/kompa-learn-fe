...
import CreateModelView from 'site/user/containers/CreateModel';
    ...
    <ModuleContainer>
      ...
      <BodyModule>
        <Switch>
          ...
          <Route exact path="/model/config/:feature2/:modelId" component={ConfigModelRoot} />
          <Route path="/model/setup/:feature2/:modelId" component={SetupDataRoot} />
          <Route path="/model/modify-data/:feature2/:modelId" component={ModifyModelRoot} />
          <Route path="/model/analysis/:feature2/:modelId" component={AnalysisRoot} />
          <Route path="/model/view-data/:feature2/:modelId" component={ViewDataRoot} />
          <Route>
